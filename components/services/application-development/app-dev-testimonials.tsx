      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-foreground/70 text-lg">
            Don't just take our word for it. Here's what our clients have to say about our application development
            services.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            ...
            >
              <div className="absolute -top-5 -left-5 bg-gradient-to-r from-indigo-600 to-purple-600 text-white p-2 rounded-full">
